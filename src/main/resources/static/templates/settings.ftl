                    ...
                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                               aria-controls="contact" aria-selected="false">Bazy danych</a>
                        </li>
                    </ul>
                        ...
                        <div class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <p class="text-muted mb-0">Usuwa wszystkie informacje o użytkownikach oraz ich
                                        obrazach</p>
                                </div>
                                <div class="col-auto">
                                    <div class="custom-control custom-switch">
                                        <button class="btn btn-outline-dark" onclick="deleteAllData()">Wyczyść dane
                                        </button>
